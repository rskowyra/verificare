...
#define Index(x, y)	Boundcheck(x, y, 0, 0, 0)
	...
	case 6:	/* :never: */
		((P6 *)pptr(h))->_t = 6;
		((P6 *)pptr(h))->_p = 7; reached6[7]=1;
		/* locals: */
		/* params: */
		break;
	case 5:	/* :init: */
		((P5 *)pptr(h))->_t = 5;
		((P5 *)pptr(h))->_p = 7; reached5[7]=1;
		/* locals: */
		/* params: */
		break;
	case 4:	/* registrar */
	...
	case 2:	/* llcnoloss */
		...
		/* params: */
#ifdef VAR_RANGES
		logval("llcnoloss:type", ((P2 *)pptr(h))->type);
#endif
		break;
	case 1:	/* macuser2 */
		((P1 *)pptr(h))->_t = 1;
		...
		((P1 *)pptr(h))->n = par0;
#ifdef VAR_RANGES
		logval("macuser2:n", ((P1 *)pptr(h))->n);
#endif
		break;
	case 0:	/* macuser1 */
		((P0 *)pptr(h))->_t = 0;
		((P0 *)pptr(h))->_p = 3; reached0[3]=1;
		/* locals: */
		/* params: */
		((P0 *)pptr(h))->n = par0;
#ifdef VAR_RANGES
		logval("macuser1:n", ((P0 *)pptr(h))->n);
#endif
		break;
	}
	this = o_this;
